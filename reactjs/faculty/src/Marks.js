...
class Marks extends Component {
  ...
  fetchMark = () => {
    ...
    if (!id) {
      alert("No mark ID found in URL");
      return;
    }

    axios.get(`http://127.0.0.1:5000/marks/mark/${id}`)
      .then(response => {
        this.setState({ marks: response.data });
      })
      .catch(error => {
        console.error("Error fetching data:", error);
        alert("Failed to fetch mark");
      });
  };
                      ...
                      <div className="product w-100">
                        <div className="product-content">
                          ...
                          <div className="course-group d-flex mb-3 align-items-center">
                            ...
                            <Link to="/Add_Marks" className="btn ms-auto" style={{ backgroundColor: "#FFE2DF", color: "#000" }} >
                              Add
                            </Link>
                          </div>
