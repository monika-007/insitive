              ...
              <div className="col-md-10">
                <div className="card shadow-lg">
                  <div className="card-header bg-danger-light text-white d-flex justify-content-between align-items-center">
                    <h4>Assignment</h4>
                    <Link className="btn btn-light" to="/assignment">Back</Link>
                  </div>
                  <div className="card-body">
                    <form onSubmit={this.handleSubmit}>
                      <div className="mb-3">
                        <label htmlFor="Tital" className="form-label">Name</label>
                        <input type="text" className="form-control" id="Tital" placeholder="Enter Test name" name="name" value={this.state.name} onChange={this.handleChange} required />
                      </div>
                      <div className="mb-3">
                      ...
                      <div className="mb-3">
                        ...
                        <input type="text" className="form-control" id="Description" placeholder="Enter test Description"  name="description" value={this.state.description} onChange={this.handleChange} required />
                      </div>
                      <div className="mb-3">
                        <label htmlFor="Due Date" className="form-label">Due Date</label>
                        <input type="date" className="form-control" id="Due Date" placeholder="EnterDue Date" name="due_date" value={this.state.due_date} onChange={this.handleChange} required />
                      </div>
                      <div className="mb-3">
                        <label htmlFor="Total Marks" className="form-label">Total Marks</label>
                        <input type="text" className="form-control" id="Total Marks" placeholder="Enter Total Marks" name="total_marks" value={this.state.total_marks} onChange={this.handleChange} required />
                      </div>
